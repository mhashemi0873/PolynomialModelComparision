...
do
    ...
    python ComputeIC_Hypos_csv.py   data_input2D.npz   ${model}.stan   data_output_CV_${alg}_${model}

    echo "...Computing IC terminated."

    echo "...Computing PSIS-LOO..."

    python ComputePSIS_Hypos_csv.py  data_input2D.npz  ${model}.stan   data_output_CV_${alg}_${model}
