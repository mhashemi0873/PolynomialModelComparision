...
namespace Hypos2D_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/home/meysam/WorkLinux/PolynomialModelComparision/PolynomialInferHypos/Hypos2D.stan");
    reader.add_event(41, 41, "end", "/home/meysam/WorkLinux/PolynomialModelComparision/PolynomialInferHypos/Hypos2D.stan");
    return reader;
}

class Hypos2D_model : public prob_grad {
private:
    int nt;
    double sd_value;
    double mu_value;
    ...
    vector<double> yobs;
public:
    Hypos2D_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "Hypos2D_model_namespace::Hypos2D_model";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "mu_value", "double", context__.to_vec());
            mu_value = double(0);
            vals_r__ = context__.vals_r("mu_value");
            pos__ = 0;
            mu_value = vals_r__[pos__++];
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "Hypos2D_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef Hypos2D_model_namespace::Hypos2D_model stan_model;
