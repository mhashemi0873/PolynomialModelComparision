...
namespace HypoGood_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/home/meysam/WorkLinux/PolynomialModelComparision/PolynomialInferHypos/HypoGood.stan");
    reader.add_event(43, 43, "end", "/home/meysam/WorkLinux/PolynomialModelComparision/PolynomialInferHypos/HypoGood.stan");
    return reader;
}

class HypoGood_model : public prob_grad {
private:
    int nt;
    double sd_value;
    vector<double> t;
    vector<double> yobs;
public:
    HypoGood_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "HypoGood_model_namespace::HypoGood_model";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "HypoGood_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef HypoGood_model_namespace::HypoGood_model stan_model;
