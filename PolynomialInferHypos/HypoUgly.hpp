...
namespace HypoUgly_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/home/meysam/WorkLinux/PolynomialModelComparision/PolynomialInferHypos/HypoUgly.stan");
    reader.add_event(46, 46, "end", "/home/meysam/WorkLinux/PolynomialModelComparision/PolynomialInferHypos/HypoUgly.stan");
    return reader;
}

class HypoUgly_model : public prob_grad {
private:
    int nt;
    double sd_value;
    vector<double> t;
    vector<double> yobs;
public:
    HypoUgly_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "HypoUgly_model_namespace::HypoUgly_model";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            local_scalar_t__ mu1_value;
            (void) mu1_value;  // dummy to suppress unused var warning

            stan::math::initialize(mu1_value, DUMMY_VAR__);
            stan::math::fill(mu1_value,DUMMY_VAR__);
            current_statement_begin__ = 20;
            local_scalar_t__ mu2_value;
            (void) mu2_value;  // dummy to suppress unused var warning

            stan::math::initialize(mu2_value, DUMMY_VAR__);
            stan::math::fill(mu2_value,DUMMY_VAR__);


            current_statement_begin__ = 22;
            stan::math::assign(mu1_value, 5);
            current_statement_begin__ = 23;
            stan::math::assign(mu2_value, -(15));
            current_statement_begin__ = 25;
            lp_accum__.add(normal_log<propto__>(p2, mu1_value, sd_value));
            current_statement_begin__ = 26;
            lp_accum__.add(normal_log<propto__>(p1, mu1_value, sd_value));
            current_statement_begin__ = 27;
            lp_accum__.add(normal_log<propto__>(p0, mu2_value, sd_value));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "HypoUgly_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef HypoUgly_model_namespace::HypoUgly_model stan_model;
