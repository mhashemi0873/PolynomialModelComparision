...
namespace Hypo1_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/home/meysam/WorkLinux/PolynomialModelComparision/PolynomialCompareHypos/Hypo1.stan");
    reader.add_event(40, 40, "end", "/home/meysam/WorkLinux/PolynomialModelComparision/PolynomialCompareHypos/Hypo1.stan");
    return reader;
}

class Hypo1_model : public prob_grad {
private:
    int nt;
    vector<double> t;
    vector<double> yobs;
public:
    Hypo1_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "Hypo1_model_namespace::Hypo1_model";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(normal_log<propto__>(p2, 5, 0.050000000000000003));
            current_statement_begin__ = 19;
            lp_accum__.add(normal_log<propto__>(p1, 5, 0.050000000000000003));
            current_statement_begin__ = 20;
            lp_accum__.add(normal_log<propto__>(p0, 5, 0.050000000000000003));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "Hypo1_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef Hypo1_model_namespace::Hypo1_model stan_model;
