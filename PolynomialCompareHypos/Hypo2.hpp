...
namespace Hypo2_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/home/meysam/WorkLinux/PolynomialModelComparision/PolynomialCompareHypos/Hypo2.stan");
    reader.add_event(40, 40, "end", "/home/meysam/WorkLinux/PolynomialModelComparision/PolynomialCompareHypos/Hypo2.stan");
    return reader;
}

class Hypo2_model : public prob_grad {
private:
    int nt;
    vector<double> t;
    vector<double> yobs;
public:
    Hypo2_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "Hypo2_model_namespace::Hypo2_model";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(normal_log<propto__>(p2, 5, 2));
            current_statement_begin__ = 19;
            lp_accum__.add(normal_log<propto__>(p1, 5, 2));
            current_statement_begin__ = 20;
            lp_accum__.add(normal_log<propto__>(p0, 5, 2));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "Hypo2_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef Hypo2_model_namespace::Hypo2_model stan_model;
